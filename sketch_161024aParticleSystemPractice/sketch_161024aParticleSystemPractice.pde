// designed by Linne S. Huang
// reference: Mintesino Zewdu
...
// When a variable is declared with the static keyword, all instances of that class share the same variable. 
